...
export const appCopy = {
  ...
  storefrontCatalog: {
    heroEyebrow: "Seleccion de temporada",
    heroTitle: "Tecnologia y hogar, con onda.",
    heroDescription:
      "Productos elegidos a mano, envio rapido a AMBA y pago seguro. Compra como invitado, sin vueltas.",
    heroPrimaryCta: "Ver catalogo",
  ...
  orderTracking: {
    ...
    timelineTitle: "Estado del envio",
    currentLabel: "Ahora",
    trackingCta: "Abrir enlace de seguimiento",
    continueShopping: "Volver a la tienda",
    shippingTitle: "Envio a",
    contactCta: "¿Algun problema? Contactanos",
    totalLabel: "Total",
    sublineCreated: "Realizado el",
  ...
  adminLogin: {
    ...
    sectionEyebrow: "Panel de administracion",
    sectionTitle: "Inicia sesion",
    restrictedHint: "Acceso restringido al equipo",
